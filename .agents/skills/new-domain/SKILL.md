...
Run from the cluster root (`de-braighter/`, this workbench's working tree — the `.Codex/`
...
Confirm the working tree is the cluster root `de-braighter/` (the `.Codex/` host) and that
